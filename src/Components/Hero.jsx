...
function Hero() {
  return (
    <div className='pl-10 bg-green-100 flex items-center gap-10 justify-evenly'>  
      ...
      <p className='border px-2 py-1 rounded-md bg-black text-green-100 cursor-pointer'>Shop Now</p>
      <p className='border border-black px-2 py-1 rounded-md bg-green-100 cursor-pointer'>Watch Video</p>
      </div>
      <p className='pb-4 pt-4'>160+ plant species | 100+ clients</p></div>
      <div className='hidden md:flex w-[500px] p-4 '>
            <img src={g1} alt="" className='cursor-pointer' />
      </div>
    </div>
  )
}
